...
@Component({
  selector: 'app-shell',
  standalone: true,
  imports: [HeaderComponent, HomeComponent, SkillsComponent, ExperienceComponent, ProjectsComponent, CertificationsComponent, ContactComponent, ScrollToTopComponent],
